...
<body>
    ...
    if(isset($_GET['idedit'])){
       $idedit=$_GET['idedit'];
        $result1=mysqli_query($conn, "SELECT * FROM tintuc WHERE matt='$idedit'");
        ...
        if(isset($_POST['xacnhan'])){
            ...
            $ndngan=$_POST['ndngan'];
            $result=mysqli_query($conn,"UPDATE tintuc SET  tieude='$tieude', noidung='$noidung', hinhanh='$hinhanh', noidungngan='$ndngan' WHERE matt='$idedit'");
            if($result){
                echo "<script>
                    alert('Bạn đã sửa thành công');
                    window.open('admin.php?content1=qltt','_self', 1);
                </script>";
            }
          }  
         ?>   
    <div class="vien" style="margin-top: 30px;">
            <form method="POST" action="" enctype="multipart/form-data" name="form1" onSubmit="return kt()">
            <table width="580px" border="0" cellspacing= 35px style="background-color:#BDBDBD;"  >
                <tr>
                    <td width="140px">Tiêu đề</td>
                    <td width ="430px"><input type="text" name='tieude' size="40" value="<?=$row['tieude']?>">
                    </td>
                ...
                <tr>
                    <td>Nội dung</td>
                    <td><input type ="text" name="noidung" size="40" value="<?=$row['noidung']?>"></td>
                ...
                <tr>
                    <td>Nội dung ngắn</td>
                    <td>
                        <textarea name="ndngan" rows="8" cols="45" ><?=$row['noidungngan']?>"</textarea>
                ...
                <tr>
                    <td></td>
                    <td><input class="btn" type="submit" name ="xacnhan" value="Cập nhập">&nbsp;<input class="btn" type="reset" value="Làm lại"></td>
                </tr>
