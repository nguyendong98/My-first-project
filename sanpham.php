...
<?php
			 ...
			 $sql="SELECT * FROM sanpham  WHERE loai=1 order by masp  asc limit ".$item_per_page." offset ".$offset."";
			 $total_product=mysqli_query($conn,"SELECT * FROM sanpham WHERE loai=1");
